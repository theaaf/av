...
public:
    ...
    void Log(Aws::Utils::Logging::LogLevel level, const char* tag, const char* format, ...) override { // NOLINT(cert-dcl50-cpp)
        va_list args;
        va_start(args, format); // NOLINT(cppcoreguidelines-pro-type-vararg, hicpp-vararg)
    ...
    void LogStream(Aws::Utils::Logging::LogLevel level, const char* tag, const Aws::OStringStream &messageStream) override {
